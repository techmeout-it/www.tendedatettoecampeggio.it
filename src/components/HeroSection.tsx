...
const HeroSection = () => {
  ...
  const stats = [
    { icon: Users, value: "40K+", label: t('hero.stats.members') },
    { icon: MessageCircle, value: "150+", label: t('hero.stats.posts') },
    { icon: TrendingUp, value: "28K+", label: t('hero.stats.active') },
    { icon: Star, value: "4.8", label: t('hero.stats.rating') },
  ];
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold text-foreground leading-tight">
                {t('hero.titlePart1')}<span className="bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">{t('hero.titleHighlight')}</span>{t('hero.titlePart2')}
              </h1>
