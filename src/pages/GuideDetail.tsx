...
const guidesData: Record<string, {
  ...
  "basilicata-coast-to-coast-tenda-da-tetto": {
    ...
    content: [
      "Nel film \"Basilicata coast to coast\" quattro amici, uniti dalla passione per la musica, attraversano la regione lucana a piedi, portando con sé soltanto i propri strumenti. Affascinati dalla pellicola di Rocco Papaleo e desiderosi di scoprire Matera, abbiamo scelto di ripercorrere quell'itinerario iconico a modo nostro, viaggiando con la tenda da tetto. Dalla costa tirrenica di Maratea fino a quella jonica di Metaponto, attraversando l'entroterra e concludendo nella straordinaria città dei Sassi, abbiamo vissuto un viaggio dove mare e montagna si incontrano, tra tradizioni popolari, borghi abbandonati e località dal fascino contemporaneo.",
      "## La Basilicata",
      "La Basilicata — conosciuta anche come Lucania — è una terra capace di sorprendere e ancora poco battuta dal turismo di massa. Situata nel sud Italia, si affaccia sia sul Mar Tirreno che sul Mar Ionio e conta due soli capoluoghi: Potenza e Matera. È una regione dalle radici antichissime, sospesa tra due mari e caratterizzata da rilievi suggestivi e panorami spettacolari: dalle Dolomiti Lucane al Parco Nazionale del Pollino. Un territorio autentico, accogliente e ricco di patrimonio artistico e naturalistico.",
      "### Il nostro itinerario in numeri",
      "- 13 giorni\n- 2630 km\n- 7 tappe",
      "Partiti da Verona, abbiamo suddiviso il viaggio in tappe intermedie sia all'andata che al ritorno. Il meteo instabile ci ha costretti più volte a modificare il programma, ma è proprio qui che entra in gioco la libertà della tenda da tetto: la possibilità di reinventare il percorso giorno dopo giorno.",
      "## 1ª Tappa – Caserta",
      "Prima sosta del viaggio: Caserta. Inizialmente avevamo previsto di fermarci a Cassino, ma le condizioni meteo ci hanno fatto cambiare programma.",
      "![La Reggia di Caserta](/img_articles/basilicata_coast/reggia_di_caserta.jpg)",
      "Abbiamo pernottato all'Area Sosta Camper Feudo San Martino, a pochi passi dalla Reggia di Caserta. Eccezionale patrimonio monumentale, storico, paesaggistico e naturalistico, incluso tra i siti patrimonio dell'UNESCO, la visita al parco prevede un percorso a piedi di una decina di km (costo del biglietto 10€) dove è possibile seguire la via dell'acqua, ossia una successione di fontane che culmina nella cascata al vertice. Terminata la visita siamo rientrati a piedi all'area sosta, comoda ed essenziale nei servizi.",
      "## 2ª Tappa – Maratea",
      "![Basilicata coast to coast in tenda da tetto](/img_articles/basilicata_coast/copertina.jpg)",
      "Entriamo ufficialmente in Basilicata con Maratea, soprannominata la \"Perla del Tirreno\". Situata nel Golfo di Policastro, vanta 32 km di costa incastonata tra Campania e Calabria.",
      "Abbiamo soggiornato al Villaggio Camping Maratea, in località Castrocucco, unico campeggio dell'intero litorale. Il tempo non è stato sempre favorevole, ma siamo riusciti comunque a fare il bagno nelle splendide spiagge di La Secca, A' Gnola e Macarro, autentiche piscine naturali dai riflessi turchesi.",
      "Imperdibile il centro storico, terrazza panoramica affacciata sul mare, e la salita al Cristo Redentore di Maratea, la cui statua bianca domina il paesaggio abbracciando cielo e mare.",
      "Durante una giornata incerta ci siamo spinti nell'entroterra fino a San Severino Lucano, nel Parco Nazionale del Pollino, regno del pino loricato, specie rarissimo simbolo del parco. Qui abbiamo scoperto la curiosa Giostra Panoramica RB Ride, opera dell'artista Carsten Höller: dieci minuti per un giro completo, la più lenta al mondo. Un punto di vista insolito e poetico sul paesaggio.",
      "Pranzo all'agriturismo Crescente, a Mezzana Cianci: cucina a km 0, prodotti propri e qualità eccellente.",
      "## 3ª Tappa – Pisticci e la Terra dei Calanchi",
      "![La Terra dei Calanchi](/img_articles/basilicata_coast/terra_dei_calanchi.jpg)",
      "Da Maratea a Pisticci abbiamo attraversato la spettacolare Terra dei Calanchi: si tratta di una zona dove la natura ha creato degli scenari fantastici che ricordano la Cappadocia o i paesaggi dei film western, fatta di profondi canyon e aride dune bianche. Carlo Levi nel suo \"Cristo si è fermato ad Eboli\" scriveva: \"…da ogni parte non c'erano che precipizi di argilla bianca, su cui le case stavano liberate nell'aria…\".",
      "![Aliano, il borgo di Carlo Levi](/img_articles/basilicata_coast/aliano.jpg)",
      ...
      "![Craco, il borgo fantasma](/img_articles/basilicata_coast/craco.jpg)",
      ...
      "Infine, ci siamo recati a **Pisticci**, la città bianca della Basilicata jonica, dove abbiamo sostato presso l'Agriturismo Il Calanco, che dispone di area sosta camper attrezzata. Pisticci si trova a metà strada tra la terra dei calanchi e le spiagge del Mar Jonio; la sua principale caratteristica è rappresentata dalle tipiche casette bianche, ciascuna col tetto rosso, affiancate l'una all'altra. L'Amaro Lucano conosciuto in tutto il mondo è nato proprio nel comune di Pisticci.",
      "Mi sento di consigliare l'Agriturismo dove abbiamo sostato sia per i servizi di cui dispone (c/s, bagni, lavatrice) ma anche per la deliziosa e abbondante cena. L'area sosta si trova vicino alla \"Casa degli animali\" in quanto agriturismo; ad accoglierci sono venuti i cagnoloni che vi abitano (tutti adottati dai gestori) e la mattina seguente la sveglia è suonata col raglio dell'asinello. Amando gli animali abbiamo gradito particolarmente questo luogo.",
      "A poca distanza dall'agriturismo si trova il **Teatro dei Calanchi**, che può essere raggiunto oltre che con il proprio mezzo, anche in bicicletta. Attenzione che la strada non è asfaltata e presenta molte buche. Si tratta di un connubio tra natura incontaminata e arte: poltrone di paglia, palcoscenico naturale rappresentato dai calanchi, un luogo estremamente suggestivo per lo spettacolo teatrale.",
      "## 4ª Tappa – Metaponto",
      "![Le Tavole Palatine di Metaponto](/img_articles/basilicata_coast/tavole_palatine.jpg)",
      "Sulla costa jonica, nel Golfo di Taranto, abbiamo soggiornato al Camping Julia, immerso nella pineta accanto alla riserva naturale. Metaponto custodisce l'antica area archeologica di Metapontum e le Tavole Palatine, tempio dedicato alla dea Hera, con le sue quindici colonne doriche ancora svettanti.",
      "Abbiamo visitato anche Policoro e l'Oasi WWF del Bosco Pantano, centro di recupero fauna selvatica e tutela delle tartarughe marine.",
      "Ci siamo poi recati a visitare **Tursi**, un borgo costituito da un groviglio di casupole circondato da profondi precipizi che Albino Pierro, poeta locale, chiamava \"jaramme\". Una volta parcheggiato ai piedi del borgo dove si trova la zona moderna del paese, è iniziata la nostra risalita: un anziano del posto si è offerto per farci da guida, accompagnandoci lungo le vie. Sulla sommità si trova \"La Rabatana\", il quartiere arabo di Tursi, a mio avviso il più bello e caratteristico di tutta la Basilicata. L'abitato sembra un labirinto, fatto di case che sembrano sgretolarsi, stretti vicoli e ripide scalinate.",
      "Infine, siamo stati a visitare **Montalbano Jonico**, anch'esso borgo disteso sui solchi dei calanchi, da dove s'intravedono in lontananza le acque dello Jonio che lambiscono questa terra.",
      "## 5ª Tappa – Matera",
      "![Matera di sera](/img_articles/basilicata_coast/matera_di_sera.jpg)",
      "Raggiungiamo **Matera**, capitale europea della cultura 2019 e sito UNESCO dal 1993 per i Sassi e il Parco delle Chiese Rupestri. Abbiamo sostato all'Area Sosta Camper Kartodromo, con servizio navetta per il centro. La visita al tramonto dal belvedere della Murgia è stata emozionante: Matera illuminata sembra un presepe. Il giorno seguente abbiamo esplorato il centro storico, una casa-grotta e il complesso rupestre di Madonna delle Virtù e San Nicola dei Greci.",
      "Una città abitata ininterrottamente fin dalla preistoria, unica al mondo.",
      "## 6ª Tappa – Marina di Petacciato",
      "![Marina di Petacciato](/img_articles/basilicata_coast/petacciato.jpg)",
      "Sulla via del ritorno sosta a Marina di Petacciato, vicino Termoli, all'Area Camper Villaggio La Torre, direttamente sul mare. Spiaggia attrezzata, lunga distesa libera accessibile anche ai cani e panorama suggestivo. Un luogo che merita di essere ricordato.",
      "## 7ª Tappa – Campo Imperatore",
      "![Campo Imperatore](/img_articles/basilicata_coast/campo_imperatore.jpg)",
      "Ultima tappa: Campo Imperatore, il \"Piccolo Tibet\" d'Abruzzo, nel massiccio del Gran Sasso. Siamo arrivati all'Osservatorio Astronomico, nella località di Fonte Cerreto Assergi, nel pomeriggio, tirava un forte vento e l'orizzonte era grigio. La nostra idea era inizialmente quella di fermarci lì la notte e il giorno seguente salire al Rifugio Duca degli Abbruzzi.",
      "Il vento era talmente forte che ci ha obbligati a scendere di circa 500m per riuscire a trovare uno spot dove fermarci per la cena. Purtroppo, il maltempo che ci ha accompagnato per tutta la vacanza, è arrivato anche lì: le raffiche ci hanno costretti a chiudere la maggiolina in piena notte e a spostarci. Tra un temporale e l'altro abbiamo chiuso tutto e siamo partiti per far ritorno verso casa.",
      "## Curiosità",
      "- Gli abitanti della Basilicata non si definiscono \"basilicatesi\", ma lucani.\n- Tra le specialità gastronomiche spiccano i peperoni cruschi di Senise, essiccati e fritti, croccanti e dolci.\n- Tipico oggetto artigianale di Matera è il \"Cucù\", un fischietto a forma di gallo, simbolo di forza e tradizionalmente dono d'amore nel corteggiamento."
    ],
    author: "Sara Sarti",
    authorAvatar: "/img_articles/autori/sara%20sarti/sara%20e%20guido%20avatar%20autori.png",
    readTime: "4 min",
